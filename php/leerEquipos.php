<?php
    ...
    switch ($accion) {
      ...
      break;
      case 'LISTAR_EQUIPOS_AZUL':
        $rows = get_equipos_rows($categoria_post);
        echo get_html_equipos_azul($rows);  
      break;
      case 'TRAER_EQUIPO':
    ...
    function get_html_equipos($rows){
      ...
      foreach ($rows as $row) {
        ...
        if($porcentaje <= 30){
          ...
          $porcentajeF = round($porcentaje);
            $html_camion_rojo = "<div class='camion-rojo'>" .
                                "<div id='".$row['cp_id']."' class='col-md-6 camion estado-camion-l'>" .
                                "  <div class='espacio-ecam-l'> " .
                                "     <div class='col-lg-3'><img src='img/iconos-menu/bidon-b3.png' class='img-bidon-l'><div class='por-camion-peq'><span>".$porcentajeF."</span></div></div> " .
                                "       <div class='col-lg-9'> " .
     ...
     //TRAE TODOS LOS CAMIONES AZULEs EN SU FORMATO HTML
    function get_html_equipos_azul($rows){
      $conn = crearConexion();
      ...
      foreach ($rows as $row) {
        ...
        if($porcentaje > 40 ){
           $html_camion_azul = "<div class='camion camion-azul'>" .
                                    "<div id='".$row['cp_id']."' class='col-lg-2 camion estado-camion-m'>" .
                                    "  <div class='espacio-ecam-m'> " .
                                    "    <div class='col-lg-3'><img src='img/iconos-menu/bidon-a4.png' class='img-bidon-m'></div>" .
                                    "      <div class='col-lg-9'>" .
                                    "        <div class='div-num-cam-m'><span class='num-cam-m2'>".$row['id_mina']."</span></div>" .
                                    "          <img src='img/iconos-menu/camion-a2.png' class='img-camion-m' title='altura actual: [".$altura_value."] , ".$porcentaje."% '> " .
                                    "        </div>" .
                                    "     </div>" .
                                    "  </div>" .
                                    "</div>" .
